...
import { Search, TrendingUp, DollarSign, Recycle } from 'lucide-react';
    ...
    <div className="page-container" style={{ paddingBottom: '90px' }}>
      ...
      <div className="glass-card" style={styles.statsContainer}>
        ...
        <div style={styles.statBox}>
          ...
          <div style={styles.statValue}>
            ₹{(stats?.MoneySaved || 0).toLocaleString()}
          </div>
  ...
  return (
    <div style={{ marginBottom: '25px' }}>
      ...
      <div style={styles.grid}>
        {items.map((item) => (
          <ItemCard
            key={item?.ItemID || item?.id || Math.random().toString()}
            item={item}
          />
        ))}
      </div>
...
const styles = {
  statsContainer: {
    ...
    color: 'white',
    backgroundImage:
      'linear-gradient(135deg, var(--primary-color), #20713b)',
    border: 'none',
  },
